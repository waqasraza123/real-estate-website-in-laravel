...
<html lang="{{ app()->getLocale() }}">
    ...
    <div class="mainWrapper">
        ...
        <nav class="mainHeaderNavigation" id="mainHeaderNavigation">
            ...
            <a id="headerAddListing" href="javascript:void(0);" title="Add a Listing">
        ...
        <footer class="mainFooter" id="mainFooter">
            ...
            <div class="social">
                <a class="footerLogo" href="/">
                    <img src="" title="Apartment Rentals"
                         alt="Apartments.com © 2017 CoStar Group, Inc.">
                </a>
        ...
        <a target="_blank" href="https://plus.google.com/+apartmentscom" class="googleIcon"></a>
        ...
        <a target="_blank" href="http://www.apartments.com/blog/" class="blogIcon"></a>
    </span>
                <p class="ehoLabel">
                    <a title="Equal Housing Opportunity" target="_blank"
                       href="http://www.apartments.com/advertise/disclaimers/equal-opportunity-in-housing-statement/">
                        <i class="ehoIcon"></i>
            ...
            <div class="footerLinksWrapper">
                <div class="footerLinks first">
                    <h5>Advertisers</h5>
                    <ul>
                        <li><a href="" title="Advertise your Apartment, Home or Condo for Rent on Apartments.com">Advertise</a>
                        </li>
                        <li><a href="" title="Add your listing on Apartments.com">Add a Listing</a></li>
                        <li><a href="" title="Digital Feeds Program">Digital Feeds Program</a></li>
                        <li><a href="" title="Customer Portal">Customer Portal</a></li>
                        <li><a href="" title="Apartment Community Resources">Community Voice</a></li>
                    </ul>
                </div>
