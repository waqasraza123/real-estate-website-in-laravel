            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title pull-left">blog  Table</h3>
                        <a href="{{ route('admblogCreate') }}" class="btn btn-info pull-right">Create a new post</a>
                            ...
                            @if($users->first())
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        <td>{{ $user->phone }}</td>
                                        <td><a href="{{ route('admEditblog' , ['id' => $user->id ]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i></a></td>
                                        <td><a href="{{ route('admDeleteblog' , ['id' => $user->id]) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                @endforeach
                            @endif
                            </tbody>
