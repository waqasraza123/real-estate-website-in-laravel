                        ...
                        <div class="dark-col margin-top-60">
                            <div class="row">
                                ...
                                <div class="grid">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="margin-top-60">
                                            <input value="{{ $listing->address }} " id="geocomplete" name="address" type="text" class="input-full main-input" placeholder="Adress">
                                ...
                                <div class="descriptionAmenitiesWrapper">
                                    ...
                                    <div class="grid">
                                        <textarea id="description"  name="description" rows="6" class="input-full main-input property-textarea" placeholder="Tell us about your place." title="">{{ $listing->description }}</textarea>
                                    </div>
                                    <div class="grid">
                                    ...
                                    <div class="grid">
                                        <div class="cell-sm-4">
                                            <select id="laundry" class="selectpicker laundry"  name="loundry_type" title="" style="display: none;">
                                                ...
                                                <option value="81" @if($listing->loundry_type == '81')  selected  @endif>Washer/Dryer</option>
                                                <option value="82" @if($listing->loundry_type == '82')  selected  @endif>Washer/Dryer Hookup</option>
                                                <option value="48" @if($listing->loundry_type == '48')  selected  @endif>Laundry Facilities</option>
                                            </select>
                                        </div>
                                        <div class="cell-sm-4">
                                            <select id="parking" class="selectpicker parking" name="parking_type"  title="" style="display: none;">
                                                <option value="">Parking Type</option>
                                                <option value="1" @if($listing->parking_type == '1')  selected  @endif>Surface Lot</option>
                                                <option value="3" @if($listing->parking_type == '3')  selected  @endif>Covered</option>
                                                <option value="4" @if($listing->parking_type == '4')  selected  @endif>Street</option>
                                                <option value="5" @if($listing->parking_type == '5')  selected  @endif>Garage</option>
                                                <option value="7" @if($listing->parking_type == '7')  selected  @endif>Other</option>
                                            </select>
                                        </div>
                                        <div class="cell-sm-4">
                                            <input id="parkingFee-clone" value="{{ $listing->parking_fee }}" name="parking_fee" type="text" placeholder="Parking Fee $ /mo" class="input-full main-input" maxlength="11" title="" style="text-align: right;" class="">
                                        </div>
                                    </div>
                                </div>
